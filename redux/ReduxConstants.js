...
export const EXPIRED_AD_DETAILS_FOR_VENDOR_STATE = 'EXPIRED_AD_DETAILS_FOR_VENDOR_STATE'
export const REGISTER_AD_CHANGE = 'REGISTER_AD_CHANGE'
export const EXPIRE_AD_CHANGE = 'EXPIRE_AD_CHANGE'
export const RENEW_AD_CHANGE = 'RENEW_AD_CHANGE'
