                    ...
                    <View style={styles.plansContainer}>
                        ...
                        <View style={styles.PriceTag}>
                            <SubscriptionTag
                                ...
                                ImageStyle={{ width: wp('1%'), height: hp('2%') }}
                                price={styles.ElitePrice}
                                planName="Elite"
                                planPrice="2399"
                                month="@12 Month"
                        ...
                        >
                            ...
                            <View style={styles.PriceTag}>
                                <SubscriptionTag
                                    Image={require('../assets/plans/Crown.png')}
                                    planName="Elite"
                                    ImageStyle={{ width: wp('6.5%'), height: hp('2%') }}
                                    planPrice="2399"
                                    price={styles.ElitePrice}
                                    month="@12 month"
                                    Starting="21 September, 2021"
                                    ...
                                    buttonNameStyles={styles.buttonNameStylesCrown}
                                    Icon="refresh"
                                    onPress={() => navigation.navigate('BasicPlans')}
                                />
                            </View>
