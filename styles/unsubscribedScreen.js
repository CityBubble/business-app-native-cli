        ...
        <View style={styles.plansContainer}>
            ...
            >
                <View style={styles.PriceTag}>
                    <Image source={require('../assets/arts/banner.png')} style={{ width: '100%', height: 88, bottom: 20 }} />
                    <View style={styles.bannerContainer}>
                        <View style={styles.bannerText} >
                            <Text style={styles.bannerHeading} >Choose a Plan</Text>
                            <Text style={styles.bannerParagarph}>that best suits your need</Text>
                        </View>
                        <Image source={require('../assets/arts/girlIcon.png')} style={{ width: 155, height: 75, top: 10, left: 10 }} />
                    </View>
                </View>
